...
class PHPMailer {
     ...
     * @param  array    $addr A 2-element indexed array, element containing an address, element 1 containing a name like
     * @return string
     */
    ...
    public function DKIM_QP($txt) {
        ...
        for ($i = 0; $i < $len; ++$i) {
            $ord = ord($txt[$i]);
            if (((0x21 <= $ord) and ($ord <= 0x3A)) or 0x3C == $ord or ((0x3E <= $ord) and ($ord <= 0x7E))) {
                $line .= $txt[$i];
            } else {
