### 为什么用
* 不过度设计，简单、清晰、好用；
* 提供最简单基础的 MVC 框架，将性能损耗降到最低，[关于性能](https://github.com/pureisle/MicroMVC/blob/master/performance.md)；
* 按 Module 进行资源分离，以便对业务进行微服务化隔离或后期的服务便捷迁移；
* 提供简单好用的单元测试框架,[关于单元测试](https://github.com/pureisle/MicroMVC/blob/master/unittest.md)；
