...
* 提供简单好用工具类，如 [Mysql](https://github.com/pureisle/MicroMVC/blob/master/Framework/docs/controllmysql.md) 、Curl 、[多进程管理(pcntl)](https://github.com/pureisle/MicroMVC/blob/master/Framework/docs/process_manager.md)、[常驻进程任务监控保活](https://github.com/pureisle/MicroMVC/blob/master/Framework/docs/daemon_monitor.md)等资源的封装、Xhprof 性能优化工具等；
